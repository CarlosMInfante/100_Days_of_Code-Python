...
if choice1 == 'left':
    # Contiune the game
    choice2 = input(
        'You\'ve come to a lake. There is an island in the middle of the lake.  Type "wait" to wait for a boar.  Type "swim" to swim across.\n').lower()
    if choice2 == 'wait':
        # Continue the game
        choice3 = input(
        ...
        if choice3 == 'red':
            ...
            print('There was a beast in the room.  Game Over.')
        else:
            print('You did\'t pick a door.')
    else:
